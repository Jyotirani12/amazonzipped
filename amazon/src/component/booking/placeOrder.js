...
const url = "https://apilink1.herokuapp.com/menuItem"; 
const oUrl="https://apilink1.herokuapp.com/placeOrder";
                ...
                <div className="container">
                    <div className="panel panel-primary">
                        ...
                        <div className="panel-body">
                            <form action="https://paytm12.herokuapp.com/paynow" method="POST">
                                <div className="row">
